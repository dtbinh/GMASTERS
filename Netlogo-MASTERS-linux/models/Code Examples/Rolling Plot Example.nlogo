...
PENS
"Xcor" 1.0 0 -2674135 true "" "plot [xcor] of turtle 0 ; plot xcor -- there's only one turtle, so its id must be 0"
"Ycor" 1.0 0 -13345367 true "" "plot [ycor] of turtle 0 ; plot ycor -- there's only one turtle, so its id must be 0\n; don't change the range until we've plotted all\n; the way across once\nif ticks > 800                               \n[\n  ; scroll the range of the plot so\n  ; only the last 200 ticks are visible\n  set-plot-x-range (ticks - 800) ticks                                       \n]"

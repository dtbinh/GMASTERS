to setup
  clear-all                         ; clear all patch and turtle variables
  create-turtles 500 [              ; create 500 turtles in the center of the world
    setxy random-xcor random-ycor   ; place turtles randomly
...
to recolor  ;; turtle procedure
  ; The turtle sets its color according to its x-coordinate.
  ; As its x-coordinate approaches the left side of the world,
  ; the turtle becomes darker.
  ; As its x-coordinate moves to the right side of the world,

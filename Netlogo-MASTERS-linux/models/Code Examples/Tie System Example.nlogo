...
to setup
  ...
  create-planets 5
  [ set size 2
    set color blue + random 3
    fd 6 + random-float 12
    create-link-from one-of suns[ tie hide-link ]
    hatch-moons 2
    [ set size 0.5
      set color gray + random 3
      fd 1 +  random-float 3
...
226
230
untie planets from sun
ask planets [ ask my-in-links [ die ] ]
NIL
1
T
OBSERVER
...
270
tie planets to sun
ask planets [ create-link-from one-of suns [ tie hide-link ] ]
NIL
1
T
OBSERVER
...
0
Circle -7500403 true true 0 0 300
Line -2674135 false 150 150 150 0

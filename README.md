...
2. Click the Startup button (or press Q)

3. Click the Load Fasta Seq into View (or press A)

4. Click the Create director and environment agents button (or press S)

5. Click the Environment Agent - Go button (or press D). For fast simulations it is advisable to unmark the "view uptdates" option at the 3D View window.
